...
from data.lib.PlayerCollisionCallback import PlayerCollisionCallback

class Player(Entity):
	def __init__(self, app, x, y, sx, sy):
		super().__init__("Player")
		self.add(Transform(Vector2(x, y), Vector2(22, 22), 0))
		self.add(BoxCollider(sx, sy))
		self.add(Rigidbody(app, 2, 3, True))
		...
		self.add(Animation("Jump", "character", [(0,1), (1,1), (2,1), (3,1)], 0, [0.05, 0.05, 0.1, 0.5]))
		...
		self.add(PlayerCollisionCallback())